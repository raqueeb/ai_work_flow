...
class AppConfig:
    ...
    model_name: str = "google/gemma-4-e4b"  # Gemma 4 E4B model - matching LM Studio
    timeout_sec: int = 300                      # Increased for larger model
    max_retries: int = 2
    retry_backoff_factor: float = 1.5
    temperature: float = 0.3                   # Slightly higher for better reasoning
    max_tokens: int = 800                      # Increased for richer responses
