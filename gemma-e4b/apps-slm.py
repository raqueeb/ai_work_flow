...
if analyze_btn and ticket_input.strip():
    ...
    "messages": [
        {
            "role": "system", 
            "content": f"""You are a Link3 ISP Support Expert. 
            Use the following Knowledge Base to classify tickets:
            {LINK3_KB}

            ### EXAMPLES OF CORRECT OUTPUT:
            Input: "my internet red light" -> ISP-001, L2, Physical Fiber Cut, High
            Input: "netflix is slow" -> ISP-002, L3, Upstream/Peering Issue, Med
            
            ### TASK:
            Classify the user ticket. You MUST provide all four parts: ID, CATEGORY, DIAGNOSIS, URGENCY."""
        },
