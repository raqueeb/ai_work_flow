...
# --- KNOWLEDGE BASE (ISP-001 to ISP-050) ---
LINK3_KB = """
...
# Explicit keyword hints to help small models pick the correct KB entry.
# Small models (1.5B) tend to drift on ambiguous complaints — these rules anchor them.
SYSTEM_PROMPT = (
    "Knowledge Base:\n" + LINK3_KB +
    ...
    "\nRespond ONLY in this exact format, one line: ID, CATEGORY, DIAGNOSIS, URGENCY"
)
...
if analyze_btn and ticket_input.strip():
    ...
    try:
        with st.spinner('Qwen2.5-1.5B is processing...'):
            ...
            if "choices" in data:
                ...
                st.error("Model Error: Ensure Qwen2.5-1.5B is active in LM Studio.")
