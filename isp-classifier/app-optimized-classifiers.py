...
def classify_ticket(complaint: str) -> tuple[str, str]:
    ...
    1. Try keyword rules first (fast, deterministic, perfect for known patterns)
    2. Fall back to LLM for semantic understanding
    Returns (isp_code, source) where source is 'keyword' or 'llm'
    """
    # 1. Keyword match
...
st.markdown("---")
st.caption("Link3 CTO Dashboard | Powered by Local Qwen2.5-1.5B via LM Studio | Hybrid Keyword+LLM Classification")
